...
test.before(t => {
    ...
    return server.inject(requestTerr)
        .then(response => {
            terrariumId = JSON.parse(response.payload)[0]._id;
        });
...
test('Test /terrarium/temperature', t => {
    const request = Object.assign({}, {
        method: 'GET',
        url: '/terrarium/temperature',
        payload: {},
        headers: {
            authorization: token
        }
...
test('Test /terrarium/humidity', t => {
    const request = Object.assign({}, {
        method: 'GET',
        url: '/terrarium/humidity',
        payload: {},
        headers: {
            authorization: token
        }
...
test('Test /terrarium/airquality', t => {
    const request = Object.assign({}, {
        method: 'GET',
        url: '/terrarium/airquality',
        payload: {},
        headers: {
            authorization: token
        }
...
test('Test /terrarium/{terrarium_id}/thingies/{thingy_id}', t => {
    const request = Object.assign({}, {
        method: 'GET',
        url: '/terrarium/'+terrariumId+'/thingies/'+thingyId,
        payload: {},
        headers: {
            authorization: token
        }
